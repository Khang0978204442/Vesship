-- linkbio.co/khangdepzai


shared.LoaderTitle = "Đang chạy kịch bản. Vui lòng đợi!";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://87182311367312",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=87182311367312";
v24.Parent = v23;
...
if Sea3 then
    ...
    local v495 = v16.Main:AddToggle("ToggleSpawnCake", {
        Title = "Triệu Hồi con lồn Tư Lệnh Bánh",
        Description = "",
        Default = true
    });
...
if Sea3 then
    ...
    local v504 = game:GetService("Người chơi");
...
v14:Notify({
    Title = "Kiroy hub",
    Content = "Kiroy hub đã kích hoạt",
    Duration = 10
});